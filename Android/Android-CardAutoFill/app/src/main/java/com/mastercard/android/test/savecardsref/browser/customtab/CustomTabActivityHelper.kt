...
package com.mastercard.android.test.savecardsref.browser.customtab
...
class CustomTabActivityHelper : ServiceConnectionCallback {
    ...
    fun bindCustomTabsService(activity: Activity) {
        ...
        val packageName: String =
            CustomTabsHelper.getPackageNameToUse(activity) ?: return
    ...
    companion object {
        ...
        fun openCustomTab(
            ...
            if (packageName == null) {
                Toast.makeText(activity, R.string.chrome_tab_not_avaliable, Toast.LENGTH_LONG)
                    .show()
                ...
                uri?.let { customTabsIntent.launchUrl(activity, it) }
            }
        }
    }
}